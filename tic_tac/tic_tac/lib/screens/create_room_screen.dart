...
class _CreateRoomScreenState extends State<CreateRoomScreen> {
  ...
  void initState() {
    super.initState();
    print('Initializing CreateRoomScreen'); // Log initialization
    _socketMethods.createRoomSuccessListener(context);
  }

  @override
  void dispose() {
    print('Disposing CreateRoomScreen'); // Log disposal
    super.dispose();
    _nameController.dispose();
  }
            ...
            children: [
              ...
              CustomButton(
                onTap: () {
                  ...
                  print(
                      'Create button tapped, nickname: $nickname'); // Log button tap
